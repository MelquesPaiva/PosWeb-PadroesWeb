...
export const validationMessages = {
    ...
    rg: {
        valueMissing:
            "O campo de RG não pode estar vazio.",
        patternMismatch:
            "Por favor, preencha um RG válido.",
        tooShort:
            "O campo de RG não tem caractéres suficientes."
    },
    cpf: {
        valueMissing:
        ...
        tooShort:
            "O campo de CPF não tem caractéres suficientes."
    },
    aniversario: {
        valueMissing:
    ...
    termos: {
        valueMissing:
            'Você deve aceitar nossos termos antes de continuar.',
    },
}
